...
<div class="right2">
    <div class="content read">
        <h2>Selamat Datang di Data Peminjaman Buku Perpustakaan</h2>
        <a href="pinjam.php" class="create-book">Peminjaman Baru</a><a href="eksPeminjaman.php" class="export-book">Export Data</a>
        <table>
            <thead>
                <tr>
                    <td>Id pinjam</td>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                        <a href="peminjaman_update.php?id_pinjam=<?=$pinjamm['id_pinjam']?>" class="edit">Edit</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
